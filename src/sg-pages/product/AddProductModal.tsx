    ...
    try {
      if (props.action === "add") {
        ...
        const userRef = query(
          ...
          where("id", "==", props?.productPayload?.id!!)
        );
  ...
  const { values, setFieldValue, handleSubmit, errors, handleChange } =
    useFormik<ProductPayload>({
      initialValues: {
        ...
        productName: props.productPayload
          ? props.productPayload.productName
          : "",
        productDetail: props.productPayload
          ? props.productPayload.productDetail
          : "",
        quantity: props.productPayload ? props.productPayload.quantity : 0,
        wordingOrder: props.productPayload
          ? props.productPayload.wordingOrder
          : "",
        price: props.productPayload ? props.productPayload.price : 0,
        imgURL: props.productPayload ? props.productPayload.imgURL : "",
        available: props.productPayload
          ? props.productPayload.available
          : "unavailable",
        facebookId: props.productPayload
          ? props.productPayload.facebookId
          : currentUser?.providerData[0].uid!!,
        createdDate: props.productPayload
          ? props.productPayload.createdDate
            ...
            <InfoItem
              ...
              detail={
                <RadioGroup
                  ...
                  onChange={(e) =>
                    setFieldValueTypeSafe("available", e.target.value)
                  }
                >
                  <FormControlLabel
                    value="available"
